...
if __name__ == '__main__':
    ...
    russia_inside_subnets = lines_from_file('Subnets/IPv4/russia_inside.lst')
    russia_outside = lines_from_file('Russia/outside-raw.lst')
    ukraine_inside = lines_from_file('Ukraine/inside-raw.lst')
    srs_rule('russia_inside', [{"domain_suffix": russia_inside}, {"ip_cidr": russia_inside_subnets}])
    ...
    compile_mrs(russia_inside_subnets, 'russia_inside_ipcidr', behavior='ipcidr')
